  ...
  return (
    <div className="h-full flex flex-col p-6 bg-white dark:bg-gray-900">
      <div className="mb-4 flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-800 dark:text-white">Base64 Encode/Decode</h2>
          <p className="text-gray-500 dark:text-gray-400 mt-1">
            Two-pane workflow with keyboard shortcuts
            <span className="ml-2 text-xs text-gray-400 dark:text-gray-500">Cmd+E encode · Cmd+D decode · Cmd+K clear</span>
          </p>
        </div>
        <button
